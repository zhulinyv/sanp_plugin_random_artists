...
def random_artists(
    ...
    chose_artists += random.choice(year_list)
...
def gen_script(*args):
    sm = '"随机"' if args[11] == "随机" else args[11]
    sm_dyn = '"随机"' if args[12] == "随机" else args[12]
    variety = '"随机"' if args[13] == "随机" else args[13]
    decrisp = '"随机"' if args[14] == "随机" else args[14]
